...
// configuration step. It creates a namespace called `cmake_cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_cpp::cmake::project_name, cmake_cpp::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_cpp::cmake::project_version);
      return EXIT_SUCCESS;
    }
